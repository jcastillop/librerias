...
<title>Eliminar Título</title>
</head>
<script language="Javascript"> 
function confirmar(){ 
confirmar=confirm("¿ESTAS SEGURO QUE QUIERES ELIMINAR ESTE TÍTULO?"); 
if (confirmar) 
// si pulsamos en aceptar
window.location.assign("eliminar_titulos.php?dato=<?php echo $_GET['id']; ?>")
else 
...
<p>&nbsp;</p>
<p>&nbsp; </p>
<h1 align="center" style="margin-top: -60px;">ELIMINAR TÍTULO</h1>

...
require_once("../../../conexiones/conexion.php");
	...
	?>
          ...
          <select  name="departamento" style="width: 200px;" id="departamento" class="input username" onchange="from(document.form1.departamento.value,'madiv','cliente_prov.php')">

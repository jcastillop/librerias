...
function confirmar(){ 
confirmar=confirm("¿ESTAS SEGURO QUE QUIERES ELIMINAR ESTE USUARIO?"); 
if (confirmar) 
// si pulsamos en aceptar
window.location.assign("eliminar_sucursales.php?dato=<?php echo $_GET['id']; ?>")
else 
...
<p>&nbsp;</p>
<p>&nbsp; </p>
<h1 align="center" style="margin-top: -60px;">ELIMINAR SUCURSAL</h1>
